import { reactive, getCurrentInstance, version, unref, inject, ref, watchEffect, watch, toRef, isRef, nextTick, shallowRef, computed, isReadonly, defineComponent, h, resolveComponent, Suspense, Transition, provide, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, defineAsyncComponent, createApp } from "vue";
...
import { hasProtocol, parseURL, joinURL, isEqual, parseQuery, withTrailingSlash, withoutTrailingSlash } from "ufo";
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrRenderSuspense } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/3D-db314143.js").then((m) => m.default || m)
  },
  {
    name: "geolocation",
    path: "/geolocation",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/geolocation-baf87912.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-964e6005.js").then((m) => m.default || m)
  },
  {
    name: "music",
    path: "/music",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/music-9f206da2.js").then((m) => m.default || m)
  },
  {
    name: "rust",
    path: "/rust",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/rust-81a3203e.js").then((m) => m.default || m)
  },
  {
    name: "scanner",
    path: "/scanner",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/scanner-0ce0b329.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-5ebce829.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-18a32cd1.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
